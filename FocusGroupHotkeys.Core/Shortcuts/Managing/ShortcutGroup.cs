...
namespace FocusGroupHotkeys.Core.Shortcuts.Managing {
    ...
    public class ShortcutGroup {
        ...
        private static bool IsValidSearchForGroup(string root, string target, bool inherit) {
            return root != null && target != null && (inherit ? target.StartsWith(root) : target.Equals(root));
        }

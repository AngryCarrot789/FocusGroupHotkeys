            ...
            if (e.IsUserInitiated) {
                if (Debugger.IsAttached) {
                    ...
                    try {
                        ...
                        await IoC.MessageDialogs.ShowMessageAsync("Action execution exception", $"An exception occurred while executing '{e.ActionId ?? action.GetType().ToString()}': {ex.GetToString()}");
                        return true;
                    }
                }
            }

...
namespace FocusGroupHotkeys.Shortcuts.Bindings {
    public class ShortcutActionBinding : InputBinding {
        ...
        public static readonly DependencyProperty DataContextProperty = DependencyProperty.Register("DataContext", typeof(IHaveDataContext), typeof(ShortcutActionBinding), new PropertyMetadata(null));

        public IHaveDataContext DataContext {
            get => (IHaveDataContext) this.GetValue(DataContextProperty);
